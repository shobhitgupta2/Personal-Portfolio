const ExperienceCard = () => {
  return (
    <div
      className="lg:w-2/5 w-4/5 min-h-72 bg-stone-900 flex-col rounded-xl flex p-4 mt-2 ring-2 ring-transparent grayscale
    hover:grayscale-0 hover:ring-green-400 transition duration-300 ease-in-out"
    >
      <h1 className="text-green-400 lg:text-3xl text-2xl font-mono ">
        Software Engineering Intern - Frontend
      </h1>
      <h2 className="text-green-400 lg:text-2xl text-xl font-mono ">
        @ Veersa Technologies
      </h2>
      <p className="lg:text-lg font-mono text-gray-500 mt-3">
